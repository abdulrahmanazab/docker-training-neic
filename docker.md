...
4. [Docker swarm](http://training.play-with-docker.com/swarm-mode-intro/)
5. [Docker Compose](https://github.com/abdulrahmanazab/docker-training-neic/blob/norbis-ws-2018/docker-compose.md)
...
* [Advanced example](http://training.play-with-docker.com/beginner-linux/)
